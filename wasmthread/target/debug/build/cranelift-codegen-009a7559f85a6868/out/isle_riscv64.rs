...
pub trait Context {
    ...
    fn valid_bextend_ty(&mut self, arg0: Type, arg1: Type) -> Option<Type>;
...
pub fn constructor_gen_float_round<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/riscv64/inst.isle line 708.
...
pub fn constructor_fpu_rr<C: Context>(
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/riscv64/inst.isle line 756.
...
pub fn constructor_alu_and<C: Context>(ctx: &mut C, arg0: Reg, arg1: Reg) -> Option<Reg> {
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/riscv64/inst.isle line 776.
...
pub fn constructor_fpu_rrrr<C: Context>(
    ...
    let pattern3_0 = arg3;
    let pattern4_0 = arg4;
    // Rule at src/isa/riscv64/inst.isle line 799.
    let expr0_0 = C::temp_writable_reg(ctx, pattern1_0);
    let expr1_0 = C::gen_default_frm(ctx);
...
pub fn constructor_alu_srli<C: Context>(ctx: &mut C, arg0: Reg, arg1: i32) -> Option<Reg> {
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/riscv64/inst.isle line 821.
...
pub fn constructor_alu_rr_funct12<C: Context>(
    ...
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/riscv64/inst.isle line 827.
    let expr0_0: Type = I64;
    let expr1_0 = C::temp_writable_reg(ctx, expr0_0);
...
pub fn constructor_ext_int_if_need<C: Context>(
    ...
    let pattern2_0 = arg2;
    if pattern2_0 == I64 {
        // Rule at src/isa/riscv64/inst.isle line 841.
    ...
    if let Some(pattern3_0) = C::fits_in_32(ctx, pattern2_0) {
        // Rule at src/isa/riscv64/inst.isle line 835.
...
pub fn constructor_bnot_128<C: Context>(ctx: &mut C, arg0: ValueRegs) -> Option<ValueRegs> {
    let pattern0_0 = arg0;
    // Rule at src/isa/riscv64/inst.isle line 866.
    let expr0_0: usize = 0i128 as usize;
...
pub fn constructor_lower_bit_reverse<C: Context>(
    ...
    let pattern1_0 = arg1;
    if pattern1_0 == I8 {
        // Rule at src/isa/riscv64/inst.isle line 877.
        let expr0_0: Type = I8;
    ...
    if pattern1_0 == I32 {
        // Rule at src/isa/riscv64/inst.isle line 889.
    ...
    if pattern1_0 == I64 {
        // Rule at src/isa/riscv64/inst.isle line 897.
...
pub fn constructor_lower_ctz<C: Context>(ctx: &mut C, arg0: Type, arg1: Reg) -> Option<Reg> {
    ...
    if let Some(pattern2_0) = closure2() {
        if pattern2_0 == false {
            // Rule at src/isa/riscv64/inst.isle line 910.
...
pub fn constructor_lower_extend<C: Context>(
    ...
    if pattern1_0 == true {
        ...
        if pattern4_0 == 128i128 as u8 {
            // Rule at src/isa/riscv64/inst.isle line 1027.
            let expr0_0: bool = true;
...
pub fn constructor_lower_i128_rotr<C: Context>(
    ...
    let pattern0_0 = arg0;
    let pattern1_0 = arg1;
    // Rule at src/isa/riscv64/inst.isle line 1258.
    let expr0_0: Type = I128;
    let expr1_0: usize = 0i128 as usize;
    let expr2_0 = C::value_regs_get(ctx, pattern1_0, expr1_0);
    let expr3_0 = C::gen_shamt(ctx, expr0_0, expr2_0);
...
pub fn constructor_gen_load<C: Context>(
    ...
    let pattern3_0 = arg3;
    let pattern4_0 = arg4;
    // Rule at src/isa/riscv64/inst.isle line 1403.
...
// Generated as internal constructor for term gen_bint.
pub fn constructor_gen_bint<C: Context>(ctx: &mut C, arg0: Reg) -> Option<Reg> {
    let pattern0_0 = arg0;
...
pub fn constructor_int_load_op<C: Context>(ctx: &mut C, arg0: bool, arg1: u8) -> Option<LoadOP> {
    ...
    if pattern0_0 == true {
        ...
        if pattern2_0 == 16i128 as u8 {
            // Rule at src/isa/riscv64/inst.isle line 1702.
...
pub fn constructor_lower_icmp_over_flow<C: Context>(
    ...
    let pattern2_0 = arg2;
    if pattern2_0 == I64 {
        // Rule at src/isa/riscv64/inst.isle line 1808.
    ...
    let pattern1_0 = arg1;
    let pattern2_0 = arg2;
    // Rule at src/isa/riscv64/inst.isle line 1799.
    let expr0_0: bool = true;
...
pub fn constructor_lower_uadd_overflow<C: Context>(
    ...
    let pattern2_0 = arg2;
    if let Some(pattern3_0) = C::fits_in_32(ctx, pattern2_0) {
        // Rule at src/isa/riscv64/inst.isle line 1871.
        let expr0_0: bool = false;
        let expr1_0 = C::value_reg(ctx, pattern0_0);
            ...
            match pattern2_0 {
                &Opcode::Brz => {
                    ...
                    if let Some((pattern5_0, pattern5_1)) = C::value_slice_unwrap(ctx, pattern4_0) {
                        ...
                        let expr2_0 =
                            C::lower_brz_or_nz(ctx, &expr0_0, expr1_0, pattern7_0, pattern6_0);
                        return Some(expr2_0);
                    }
                }
                &Opcode::Brnz => {
            ...
            if let &Opcode::BrIcmp = pattern2_0 {
                ...
                if let Some((pattern5_0, pattern5_1)) = C::value_slice_unwrap(ctx, pattern4_0) {
                    ...
                    if let Some((pattern7_0, pattern7_1)) = C::value_slice_unwrap(ctx, pattern5_1) {
                        ...
                        let expr0_0 = C::put_in_regs(ctx, pattern5_0);
                        let expr1_0 = C::put_in_regs(ctx, pattern7_0);
                        let expr2_0 = C::lower_br_icmp(
                            ctx, pattern2_2, expr0_0, expr1_0, pattern8_0, pattern6_0,
                        );
                        return Some(expr2_0);
                    }
                }
...
pub fn constructor_gen_andn<C: Context>(ctx: &mut C, arg0: Reg, arg1: Reg) -> Option<Reg> {
    ...
    if let Some(pattern2_0) = closure2() {
        if pattern2_0 == true {
            // Rule at src/isa/riscv64/inst.isle line 1947.
...
pub fn constructor_gen_rev8<C: Context>(ctx: &mut C, arg0: Reg) -> Option<Reg> {
    ...
    if let Some(pattern1_0) = closure1() {
        if pattern1_0 == true {
            // Rule at src/isa/riscv64/inst.isle line 1974.
...
pub fn constructor_lower<C: Context>(ctx: &mut C, arg0: Inst) -> Option<InstOutput> {
    ...
    if let Some(pattern1_0) = C::first_result(ctx, pattern0_0) {
        ...
        if pattern2_0 == B128 {
            ...
            } = &pattern4_0
            {
                if let &Opcode::Load = pattern5_0 {
                    ...
                    let expr1_0 = constructor_gen_load_128(ctx, expr0_0, pattern5_3, pattern5_2)?;
            ...
            match &pattern4_0 {
                &InstructionData::Unary {
                    ...
                    match pattern5_0 {
                        ...
                        &Opcode::Bint => {
                            let pattern7_0 = C::valueregs_2_reg(ctx, pattern5_1);
                            // Rule at src/isa/riscv64/lower.isle line 640.
                            let expr0_0 = constructor_gen_bint(ctx, pattern7_0)?;
                            let expr1_0: u64 = 0i128 as u64;
                            let expr2_0 = C::load_u64_constant(ctx, expr1_0);
                            let expr3_0 = C::value_regs(ctx, expr0_0, expr2_0);
                ...
                &InstructionData::Binary {
                    ...
                    match pattern5_0 {
                        &Opcode::BandNot => {
                            let (pattern7_0, pattern7_1) = C::unpack_value_array_2(ctx, pattern5_1);
                            // Rule at src/isa/riscv64/lower.isle line 301.
        ...
        {
            if let &Opcode::Bextend = pattern4_0 {
                let pattern6_0 = C::value_type(ctx, pattern4_1);
                let mut closure7 = || {
                    let expr0_0 = C::valid_bextend_ty(ctx, pattern6_0, pattern2_0)?;
                    return Some(expr0_0);
                };
                if let Some(pattern7_0) = closure7() {
                    if pattern7_0 == B128 {
                        ...
                        let expr1_0: Type = I64;
                        let expr2_0: Type = I64;
                        let expr3_0 = C::gen_moves(ctx, expr0_0, expr1_0, expr2_0);
                        let expr4_0 = constructor_convert_valueregs_reg(ctx, expr3_0)?;
                        let expr5_0 = C::put_in_regs(ctx, pattern4_1);
                        let expr6_0: Type = I64;
                        let expr7_0: Type = I64;
                        let expr8_0 = C::gen_moves(ctx, expr5_0, expr6_0, expr7_0);
            ...
            match &pattern4_0 {
                &InstructionData::Unary {
                    ...
                    if let &Opcode::Bnot = pattern5_0 {
                        // Rule at src/isa/riscv64/lower.isle line 254.
                        let expr0_0 = C::put_in_regs(ctx, pattern5_1);
        ...
        if pattern2_0 == F32 {
            ...
            match &pattern4_0 {
                &InstructionData::Unary {
                    ...
                    match pattern5_0 {
                        &Opcode::Bnot => {
                            // Rule at src/isa/riscv64/lower.isle line 257.
                            let expr0_0 = C::put_in_reg(ctx, pattern5_1);
                ...
                &InstructionData::Binary {
                    ...
                    match pattern5_0 {
                        ...
                        &Opcode::Bxor => {
                            let (pattern7_0, pattern7_1) = C::unpack_value_array_2(ctx, pattern5_1);
                            // Rule at src/isa/riscv64/lower.isle line 242.
                            let expr0_0 = AluOPRRR::Xor;
                            let expr1_0 = C::put_in_reg(ctx, pattern7_0);
                            let expr2_0 = C::put_in_reg(ctx, pattern7_1);
                            let expr3_0: Type = F32;
                ...
                &InstructionData::Unary {
                    ...
                    match pattern5_0 {
                        ...
                        &Opcode::Bmask => {
                            ...
                            let expr1_0: usize = 0i128 as usize;
                            let expr2_0 = C::value_regs_get(ctx, expr0_0, expr1_0);
                            let expr3_0 = C::gen_move2(ctx, expr2_0, pattern7_0, pattern3_0);
                            let expr4_0 = constructor_output_reg(ctx, expr3_0)?;
                            return Some(expr4_0);
                        }
                        _ => {}
            ...
            &InstructionData::Unary {
                ...
                match pattern4_0 {
                    &Opcode::Copy => {
                        ...
                        let expr0_0 = C::put_in_reg(ctx, pattern4_1);
                        let expr1_0 = C::gen_move2(ctx, expr0_0, pattern2_0, pattern2_0);
                        let expr2_0 = constructor_output_reg(ctx, expr1_0)?;
                        return Some(expr2_0);
                    }
                    &Opcode::Bitrev => {
                    ...
                    &Opcode::Sextend => {
                        let pattern6_0 = C::value_type(ctx, pattern4_1);
                        // Rule at src/isa/riscv64/lower.isle line 294.
                        let expr0_0 = C::put_in_reg(ctx, pattern4_1);
                        let expr1_0: bool = true;
                        let expr2_0 = C::ty_bits(ctx, pattern6_0)?;
                        let expr3_0 = C::ty_bits(ctx, pattern2_0)?;
                    ...
                    &Opcode::FcvtToUint => {
                        let pattern6_0 = C::value_type(ctx, pattern4_1);
                        // Rule at src/isa/riscv64/lower.isle line 811.
                        let expr0_0: bool = false;
                        let expr1_0 = C::put_in_reg(ctx, pattern4_1);
                        let expr2_0: bool = false;
                    ...
                    if let Some(pattern6_0) = C::def_inst(ctx, pattern4_1) {
                        ...
                        } = &pattern7_0
                        {
                            if let &Opcode::Ffcmp = pattern8_0 {
                                ...
                                let expr0_0 = constructor_gen_fcmp(
                                    ctx,
                                    pattern4_2,
                                    pattern10_0,
                                    pattern10_1,
                    ...
                    if let Some(pattern6_0) = C::def_inst(ctx, pattern4_1) {
                        ...
                        } = &pattern7_0
                        {
                            if let &Opcode::Ifcmp = pattern8_0 {
                                ...
                                let expr0_0 = C::put_in_regs(ctx, pattern10_0);
                                let expr1_0 = C::put_in_regs(ctx, pattern10_1);
                                let expr2_0 = constructor_lower_icmp(
                                    ctx,
                                    pattern4_2,
                                    expr0_0,
                                    expr1_0,
            ...
            &InstructionData::Ternary {
                ...
                match pattern4_0 {
                    &Opcode::Select => {
                        ...
                        let expr2_0 = C::put_in_regs(ctx, pattern6_2);
                        let expr3_0 =
                            constructor_gen_select(ctx, pattern2_0, expr0_0, expr1_0, expr2_0)?;
                        let expr4_0 = C::output(ctx, expr3_0);
                        return Some(expr4_0);
                    }
                    &Opcode::Bitselect => {
    ...
    match &pattern1_0 {
        &InstructionData::NullAry {
            ...
            match pattern2_0 {
                ...
                &Opcode::GetReturnAddress => {
                    // Rule at src/isa/riscv64/lower.isle line 968.
        ...
        &InstructionData::Unary {
            ...
            match pattern2_0 {
                &Opcode::IsNull => {
                    // Rule at src/isa/riscv64/lower.isle line 616.
                ...
                if let Some(pattern4_0) = C::def_inst(ctx, pattern2_1) {
                    ...
                    } = &pattern5_0
                    {
                        if let &Opcode::Ffcmp = pattern6_0 {
                            ...
                            let expr0_0 = C::put_in_reg(ctx, pattern8_0);
                            let expr1_0 = C::put_in_reg(ctx, pattern8_1);
                            let expr2_0 = constructor_gen_trapff(
                                ctx, pattern2_2, expr0_0, expr1_0, pattern9_0, pattern2_3,
                            )?;
                            return Some(expr2_0);
                        }
                    }
                    ...
                    } = &pattern5_0
                    {
                        match pattern6_0 {
                            &Opcode::Ifcmp => {
                                ...
                                let expr0_0 = C::put_in_regs(ctx, pattern8_0);
                                let expr1_0 = C::put_in_regs(ctx, pattern8_1);
                                let expr2_0 = constructor_lower_icmp(
                                    ctx, pattern2_2, expr0_0, expr1_0, pattern9_0,
                                )?;
                                let expr3_0 = constructor_gen_trapif(ctx, expr2_0, pattern2_3)?;
                                return Some(expr3_0);
                            }
                            &Opcode::IaddIfcout => {
                                let (pattern8_0, pattern8_1) =
                                ...
                                let expr0_0 = C::put_in_reg(ctx, pattern8_0);
                                let expr1_0 = C::put_in_reg(ctx, pattern8_1);
                                let expr2_0 = constructor_lower_uadd_overflow(
                                    ctx, expr0_0, expr1_0, pattern9_0,
                                )?;
                                let expr3_0 = constructor_gen_trapif(ctx, expr2_0, pattern2_3)?;
                                return Some(expr3_0);
                            }
        ...
        &InstructionData::MultiAry {
            ...
            if let &Opcode::Return = pattern2_0 {
                let pattern4_0 = C::value_list_slice(ctx, pattern2_1);
                // Rule at src/isa/riscv64/lower.isle line 956.
                let expr0_0: usize = 0i128 as usize;
        ...
        if let Some(pattern3_0) = C::fits_in_64(ctx, pattern2_0) {
            ...
            } = &pattern4_0
            {
                match pattern5_0 {
                    &Opcode::Iadd => {
                        let (pattern7_0, pattern7_1) = C::unpack_value_array_2(ctx, pattern5_1);
                        // Rule at src/isa/riscv64/lower.isle line 32.
                        let expr0_0 = C::put_in_reg(ctx, pattern7_0);
                        let expr1_0 = C::put_in_reg(ctx, pattern7_1);
                        let expr2_0 = constructor_alu_add(ctx, expr0_0, expr1_0)?;
                        let expr3_0 = constructor_output_reg(ctx, expr2_0)?;
